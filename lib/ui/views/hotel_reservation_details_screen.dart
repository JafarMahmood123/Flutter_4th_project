...
class HotelReservationDetailsScreen extends StatelessWidget {
  ...
  const HotelReservationDetailsScreen({Key? key, required this.reservation})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => HotelReservationDetailsViewModel()
        ...
        body: Consumer<HotelReservationDetailsViewModel>(
          builder: (context, viewModel, child) {
            ...
            if (viewModel.reservation == null) {
              return const Center(
                  child: Text('Reservation details not found.'));
            }

            final int numberOfNights = viewModel
                .reservation!.reservationEndDate
                .difference(viewModel.reservation!.reservationStartDate)
                .inDays;
            final double totalPrice = (viewModel.room?.price ?? 0) * numberOfNights;
                            ...
                            child: Column(
                              children: [
                                ...
                                _buildDetailRow(
                                  ...
                                  title: 'Guests',
                                  value:
                                  '${viewModel.reservation!.numberOfPeople} people',
                                ),
                                const Divider(height: 24),
                                _buildDetailRow(
                                  context,
                                  icon: Icons.king_bed,
                                  title: 'Room Number',
                                  value: viewModel.room?.roomNumber
                                      .toString() ??
                                      'N/A',
                                ),
                                const Divider(height: 24),
                                _buildDetailRow(
                                  ...
                                  value:
                                  '\$${viewModel.room?.price.toStringAsFixed(2) ?? 'N/A'}',
                                ),
                              ],
                            ),
                          ),
                        ...
                        Card(
                          ...
                          child: Padding(
                            ...
                            child: _buildDetailRow(
                              ...
                              title: 'Total Price for $numberOfNights nights',
